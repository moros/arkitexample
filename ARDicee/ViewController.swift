...
//  ARDicee
//
//  Created by Doug Mason on 5/20/18.
...
class ViewController: UIViewController, ARSCNViewDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        if !ARWorldTrackingConfiguration.isSupported {
            fatalError("Sorry but ARWorldTracking is not supported for your device!")
        }
    ...
    func addDice(atLocation result: ARHitTestResult)
    {
    ...
    func renderer(_ renderer: SCNSceneRenderer, didAdd node: SCNNode, for anchor: ARAnchor)
    {
        ...
        gridMaterial.diffuse.contents = UIImage(named: "art.scnassets/box.png")
